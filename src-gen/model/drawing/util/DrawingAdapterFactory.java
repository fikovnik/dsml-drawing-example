...
public class DrawingAdapterFactory extends AdapterFactoryImpl {
	...
	protected DrawingSwitch<Adapter> modelSwitch =
		new DrawingSwitch<Adapter>() {
			@Override
			public Adapter caseDrawingScript(DrawingScript object) {
				return createDrawingScriptAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link model.drawing.DrawingScript <em>Script</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDrawingScriptAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link model.drawing.Command <em>Command</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link model.drawing.Forward <em>Forward</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link model.drawing.Turn <em>Turn</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
