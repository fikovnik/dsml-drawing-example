 ...
 * @generated
 */
public class DrawingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DrawingPackage.DRAWING_SCRIPT: {
				DrawingScript drawingScript = (DrawingScript)theEObject;
				T result = caseDrawingScript(drawingScript);
	 ...
	 * @generated
	 */
	public T caseDrawingScript(DrawingScript object) {
		return null;
	}
